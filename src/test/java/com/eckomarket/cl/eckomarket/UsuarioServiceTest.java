...
public class UsuarioServiceTest {
    ...
    public void testFindAll() {
        when(usuarioRepository.findAll()).thenReturn(List.of(
                new Usuario(1, "21601311", "Brayan", "Vilches", new Date(), "brayan@mail.com")
        ));
    ...
    public void testFindById() {
        Integer id = 1;
        Usuario usuario = new Usuario(1, "21601311", "Brayan", "Vilches", new Date(), "brayan@mail.com");
    ...
    public void testSave() {
        ...
        assertNotNull(saved);
        assertEquals("Brayan", saved.getNombres());
    }
